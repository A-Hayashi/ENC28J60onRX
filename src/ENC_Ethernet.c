...
static char packet_save_loc_high = 0x00;
static char packet_save_loc_low = 0x00;

/////////////////////////////////////////////		Functions	////////////////////////////////////////////

static void ENC_Write(char data);
static void ENC_Double_Write(char data1, char data2);
static void ENC_Continuous_Write(char data);
static char ENC_Continuous_Read(void);
static char ENC_Write_and_Read(char data);
static char ENC_Write_and_Read_dummy(char data);
