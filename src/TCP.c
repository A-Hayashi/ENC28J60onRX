...
static char PORTH	= 0x00;
static char PORTL	= 0x64;		// PORT 100

static uint16_t Dest_port = 100;

static unsigned long Squnc = 12458;		// My sequence number
static unsigned long Next_Ack = 0 ;		// My Ack number
static unsigned long last_data_seq_num = 0; // sequence number of the last data packet. New must be greater than that
static char ACK_Data[600];
static uint16_t ACK_length =0;
